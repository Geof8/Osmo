...
export default function Empathy() {
  ...
  return (
    <section id="observations" className="bg-[var(--paper-2)] border-b border-[var(--rule)] relative z-[5]" style={{ padding: "140px 0" }}>
      <div className="max-w-[1380px] mx-auto px-10">
          ...
          <div className="overflow-hidden">
            ...
            >
              {observations.map((obs) => (
                <article
                  key={obs.num}
                  className="flex-shrink-0 flex flex-col gap-6 p-8 min-h-[360px] bg-white border border-[var(--rule)]"
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="mt-24 pt-14 border-t border-[var(--rule)] grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-14 items-baseline"
        >
          <div
            style={{
              fontFamily: "var(--font-barlow), var(--display)",
