...
## Journal rapide
Dernière session: 2026-05-22 — SocialProof passé du sombre `#111111` à clair `#F4F4F4` (cohérence avec Benefits / PourquoiOsmo). Textes adaptés : H2 + italique `#111`, body `#444`, stats valeurs `#111` / labels `#666`, bordures haut/bas `#E8E8E8`. **Citation maintenue en ambre `#C8963E` italique** (demande explicite Geoffrey — exception au "amber restreint aux CTAs/key numbers/dots"). Aucun changement de contenu, structure ou animations.
